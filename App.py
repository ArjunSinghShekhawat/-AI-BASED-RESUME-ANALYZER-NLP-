...
connection = pymysql.connect(host='localhost',user='root',password='Arjun@2804',db='cv')
...
def run():
    ...
    link = '[©Developed by Arjun Singh](https://www.linkedin.com/in/arjun-singh-shekhawat-835b55256?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'Arjun' and ad_password == 'Arjun2804':
                st.success("Welcome Arjun Singh !")
                # Display Data
